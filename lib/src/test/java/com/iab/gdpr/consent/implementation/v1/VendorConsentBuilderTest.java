...
public class VendorConsentBuilderTest {
    ...
    public void testInvalidVendorListVersion() throws VendorConsentCreateException {
    ...
    public void testValidBidFieldEncoding() {
        ...
        assertThat(vendorConsent.getAllowedPurposeIds(),is(new HashSet<>(Arrays.asList(1, 2, 3, 24))));
    ...
    public void testValidRangedEncoding() {
        // Given: set of consent string parameters
        final Set<Integer> allowedPurposes = new HashSet<>(Arrays.asList(1, 2, 3));
        final int cmpId = 10;
