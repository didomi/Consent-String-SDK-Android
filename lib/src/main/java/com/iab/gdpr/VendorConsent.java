...
public class VendorConsent {
    ...
    private final Date consentRecordCreated;
    private final Date consentRecordLastUpdated;
    ...
    private VendorConsent(Builder builder) throws VendorConsentException {
        ...
        bits.setDateToEpochDeciseconds(GdprConstants.CREATED_BIT_OFFSET, GdprConstants.CREATED_BIT_SIZE, this.consentRecordCreated);
        bits.setDateToEpochDeciseconds(GdprConstants.UPDATED_BIT_OFFSET, GdprConstants.UPDATED_BIT_SIZE, this.consentRecordLastUpdated);
    ...
    public static class Builder {
         ...
         */
        public Builder withConsentRecordCreatedOn(Date consentRecordCreated) {
         ...
         */
        public Builder withConsentRecordLastUpdatedOn(Date consentRecordLastUpdated) {
