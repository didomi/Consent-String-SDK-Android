...
public class ByteBufferBackedVendorConsent implements VendorConsent {
    ...
    public Date getConsentRecordCreated() {
        return bits.getDateFromEpochDeciseconds(CREATED_BIT_OFFSET, CREATED_BIT_SIZE);
    }

    @Override
    public Date getConsentRecordLastUpdated() {
        return bits.getDateFromEpochDeciseconds(UPDATED_BIT_OFFSET, UPDATED_BIT_SIZE);
    }
