...
public class ConsentStringParser {
    ...
    public VendorConsent parse() {
        ...
        builder.withConsentRecordCreatedOn(bits.getDateFromEpochDeciseconds(CREATED_BIT_OFFSET, CREATED_BIT_SIZE));
        builder.withConsentRecordLastUpdatedOn(bits.getDateFromEpochDeciseconds(UPDATED_BIT_OFFSET, UPDATED_BIT_SIZE));
