...
public class Bits {
     ...
     */
    public Date getDateFromEpochDeciseconds(int startInclusive, int size) throws VendorConsentException {
        long epochDemi = getLong(startInclusive, size);
        return new Date(epochDemi * 100);
    }

    public void setDateToEpochDeciseconds(int startInclusive, int size, Date date)
            throws VendorConsentException {
